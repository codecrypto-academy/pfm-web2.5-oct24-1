...
export const Transaction: React.FC = () => {
  ...
  const displayedFields = [
    ...
    { 
      label: 'Block Number', 
      value: (
        <Link to={`/network/${id}/explorer/block/${transaction.blockNumber}`}>
    ...
    { 
      label: 'From', 
      value: (
        <Link to={`/network/${id}/explorer/address/${transaction.from}`}>
    ...
    { 
      ...
      value: transaction.to ? (
        <Link to={`/network/${id}/explorer/address/${transaction.to}`}>
