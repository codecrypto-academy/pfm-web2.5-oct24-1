    ...
    <div className="mb-2">
      ...
      >
        ...
        <div className="mb-3">
          ...
          />
          {errors.chainId && (
            <p className="text-danger">{errors.chainId.message}</p>
          )}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.subnet && (
            <p className="text-danger">{errors.subnet.message}</p>
          )}
        </div>
        <div className="mb-3">
          ...
          />
          {errors.ipBootNode && (
            <p className="text-danger">{errors.ipBootNode.message}</p>
          )}
        </div>
        ...
        <div className="mb-4">
          ...
          {errors.alloc && (
            <p className="text-danger">{errors.alloc.message}</p>
          )}
          <button
            type="button"
        ...
        <div className="mb-3">
          ...
          {errors.nodes && (
            <p className="text-danger">{errors.nodes.message}</p>
          )}
          <button
            type="button"
            className="btn btn-outline-secondary"
